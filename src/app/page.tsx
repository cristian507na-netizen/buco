...
export default async function DashboardPage() {
  ...
  try {
    ...
    // Rethrow to hit the error.tsx boundary with meaningful info
    throw new Error("Dashboard data fetch failed: Configuración insuficiente o error de base de datos");
  }
}

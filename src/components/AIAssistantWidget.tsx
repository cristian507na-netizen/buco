  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed z-[100] w-14 h-14 rounded-2xl flex items-center justify-center text-white transition-all duration-300 shadow-2xl",
      ...
      <div
        className={cn(
          "fixed z-[100] transition-all duration-500 flex flex-col overflow-hidden shadow-2xl",
